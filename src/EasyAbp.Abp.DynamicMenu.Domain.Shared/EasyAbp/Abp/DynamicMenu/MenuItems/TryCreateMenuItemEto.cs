...
namespace EasyAbp.Abp.DynamicMenu.MenuItems
{
    ...
    public class TryCreateMenuItemEto : ExtensibleObject, IMenuItem
    {
        ...
        public TryCreateMenuItemEto(string parentName, string name, string displayName, string url, string urlMvc,
            string urlBlazor, string urlAngular, string permission, string lResourceTypeName,
